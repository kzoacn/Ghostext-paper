...
\end{equation}
where $H_j$ is candidate entropy at step $j$. In the current implementation defaults, $w=32$ and $\tau=0.1$ bits. These retry parameters are sender-side controls that affect whether a run is restarted, not decode replay math itself.
