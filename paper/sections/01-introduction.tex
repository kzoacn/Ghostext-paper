...
Fourth, it provides an execution-ready evaluation plan for post-pause experiments, with explicit failure taxonomy and reproducibility requirements.

\paragraph{Scope boundary.}
The current repository is under an explicit experiment pause, so this paper does not claim finalized detector-resistance results. The present contribution is a protocol-and-analysis baseline designed to make post-pause empirical claims auditable and reproducible.
