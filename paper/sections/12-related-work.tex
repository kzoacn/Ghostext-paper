...
Direct numerical comparison against NLS/OD-Stega under a single aligned condition grid (same model, same prompt/message set, same reporting metrics) is still missing in this revision. We therefore do not make superiority claims over those baselines here.
