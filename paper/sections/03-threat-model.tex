...
The primary adversary is a passive Censor that observes text but does not modify transport content. The Censor does not know the passphrase. Prompt knowledge is treated as an adversarial capability axis rather than a fixed assumption. The released 18-trial baseline uses fixed public templates and should therefore be read as a \emph{template-known operational floor}; unknown-prompt or private-prompt conditions remain planned evaluation regimes rather than completed evidence blocks in this revision.
