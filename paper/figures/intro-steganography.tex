\begin{figure*}[t]
    ...
    \begin{minipage}[t]{0.32\textwidth}
        ...
        \begin{tikzpicture}[x=1cm,y=1cm,>=Latex,font=\small,scale=0.84,transform shape]
            ...
            \node[align=center,text width=4.1cm,font=\footnotesize] at (3.4,0.52) {``A quiet evening walk unfolds\\like a gentle melody...''};
